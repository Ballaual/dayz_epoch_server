...
if(!_armalog)then{
	...
	diag_log "<infiSTAR.de> vi9919161948";
	diag_log "<infiSTAR.de> 7bbc4c80d1c8bca4239dcd8bf95b51";
...
if(_armalog)then{
	...
	FN_ARMA_REMOTELOG = {
		...
		_logentry = _this select 1;
		"armalog" callExtension ("8"+"a2"+";;"+_logname+";;"+_logentry+";;"+"03-10-2020 23-43-24 - v1452");
	};
}
else
{
...
iproductVersion = '03-10-2020 23-43-24-v1452';
...
_fnc_RandomGen =
{
	...
	_arr = ['a','7','b','b','c','4','c','8','0','d','1','c','8','b','c','a','4','2','3','9','d','c','d','8','b','f','9','5','b','5','1'];
...
_PV_DevUlDs = _PV_DevUlDs + ['76561198152111329','765611980vi991916194866857'];comment 'DEV ID';PV_DevUlDs = _PV_DevUlDs;_SAdmins= _PV_DevUlDs + _SAdmins;
...

{
		...
		"; if(!_UIM)then{ _AHstring = _AHstring + "
			...
			if(!isNil 'r_player_unconscious')then
			{
				...
				else
				{
					...
					{
						_obj setVariable['infiUnconDone','0'];comment '#vi9919161948';
					};
				};
			};
		"; }; _AHstring = _AHstring + "
	...
	"; if(_UIM)then{ _AHstring = _AHstring + "
	diag_log format['Successfully Loaded on Client IDvi9919161948 (%1)',time];
	"; }else{ _AHstring = _AHstring + "
	systemChat '<infiSTAR.de>: Successfully Loaded In.';
	if("+str _DMS+")then{systemChat '<infiSTAR.de>: -END- key toggles the debugmonitor';};
	diag_log format['<infiSTAR.de> 03-10-2020 23-43-24-v1452 - Successfully Loaded on Client IDvi9919161948 (%1)',time];
	"; }; _AHstring = _AHstring + "
	"+_randvar27+" = true;
