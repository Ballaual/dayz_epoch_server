...
/*  SUPER ADMIN HERE      */ _SAdmins = ["76561198094473897","76561198066273558"]; //do not have a , at the end.
...
/* ********************************************************************************* */
serverName = "TEST - DayZ Epoch Chernarus Server"; // Name of this Server (same as in config file would make sense.)
/*  Top esc menu TXT      */ _TopOfESC = "Team Inf3rnal"; //do not use " in this text.
/*  Bottom esc menu TXT   */ _LowerTop = "teaminfernal.de"; //do not use " in this text.
/*  Bottom esc menu TXT2  */ _LowerBottom = ""; //do not use " in this text.
/*  Color esc menu TXT    */ _EscColor = [0.6,0,0,1];
/*  DebugMonitor TXT      */ _BottomDebug = "Teaminfernal.de"; //do not use " in this text.
...
[
	...
	"BTC_Hud","PlotManagement","DoorManagement","Entercode","#USER:_keyMenu","#USER:Suicideconfirm"
];
...
[
	...
	"s_player_upgradestorage","s_player_upgradestroage","s_player_warndog","s_player_waterdog","s_player_zombieShield","s_player_vi9919161948_copyToKey",
