...
DZE_DEPLOYABLES_CONFIG = [
    ...
    ["ItemToolbox",[0,6,1],5,0.5,false,false,false,false,false,true,true,["MMT_Civ"],[],["ItemToolbox"],"true"],
    ...
    ["ItemToolbox",[0,8,2],7,0.5,true,true,false,false,false,true,true,["CSJ_GyroC"],[],["PartVRotor","PartEngine","PartFueltank"],"true"],
