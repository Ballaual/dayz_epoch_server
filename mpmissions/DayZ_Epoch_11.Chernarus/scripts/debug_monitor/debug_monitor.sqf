...
/************************* CONFIG *************************/
	...
	_serverTitle = "Team Inf3rnal's";
	_serverSubtitle = "nostalgic A2 Epoch server"; // DELETE line 40 if you don't want this to show
	_teamspeak = "Teamspeak: teaminfernal.de"; // DELETE line 50 if you don't want this to show
	_restartTime = 180; //total time before server restart (4hrs = 48 minutes)
