...
//Has some kind of target
	...
	if (s_player_clothes < 0) then {
			s_player_clothes = player addAction [format["<t color='#0059FF'>%1</t>",localize "STR_CL_TC_TAKE_CLOTHES"],"scripts\takeclothes\takeClothes.sqf",_cursorTarget,0, false,true];
		};
	} else {
